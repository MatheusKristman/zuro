...
export function ForgotPasswordMessage({
  ...
  return (
    <div className="w-full flex flex-col items-center gap-6 bg-white rounded-3xl p-6 max-w-[450px]">
      ...
      >
        <h4 className="text-2xl font-bold text-center text-slate-800">
          Enviamos um e-mail para {recoverEmail}
        </h4>

        <p className="text-slate-600 text-center font-medium">
          Verifique sua caixa de entrada (e também a pasta de spam) para
          encontrar o link de recuperação de senha. Caso não receba o e-mail em
          alguns minutos, tente novamente ou entre em contato com o{" "}
          <a
            href="#"
            target="_blank"
