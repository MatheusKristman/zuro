...
function CancelPlanConfirmation({ cancelPlan, isPending, isOpen, setOpen }: CancelPlanConfirmationProps) {
  return (
    <AlertDialog open={isOpen}>
      <AlertDialogTrigger asChild>
        <Button onClick={() => setOpen(true)} size="xl" variant="destructive" className="w-full">
          Cancelar Plano
        </Button>
      </AlertDialogTrigger>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Tem certeza que deseja cancelar o plano?</AlertDialogTitle>

          <AlertDialogDescription>
            Você está prestes a cancelar o plano atual. Ao cancelar o plano, ele será encerrado imediatamente, e você
            não será cobrado na próxima fatura. Caso mude de ideia, poderá contratar um novo plano a qualquer momento.
...
function PlanComponent() {
  ...
  const { mutate: reactivatePlan, isPending: isReactivatingPlan } = trpc.userRouter.reactivatePlan.useMutation({
    onSuccess: (res) => {
      if (res.error) {
    ...
    onError: (err) => {
      ...
      toast.error("Ocorreu um erro ao reativar o plano, entre em contato com o suporte");
    },
  });
  const { mutate: cancelPlan, isPending: isCancellingPlan } = trpc.userRouter.cancelPlan.useMutation({
    onSuccess: (res) => {
      toast.success(res.message);
    ...
    return (
      <main className="dashboard-main">
        <div className="dashboard-container flex flex-col justify-between mb-12">
          ...
          <div className="w-full mt-10 p-6 bg-white rounded-3xl flex flex-col gap-12">
  ...
  if (!data || !data.plan) {
    return (
      <main className="dashboard-main">
        <div className="dashboard-container flex flex-col justify-between mb-12">
          <h2 className="text-3xl font-bold text-center text-white mt-10">Reative o seu plano</h2>
              ...
              <div className="w-full grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                <div className="w-full p-4 bg-skin-primary rounded-2xl flex flex-col justify-between gap-4">
                  <div className="w-full flex flex-col gap-6">
                    <div className="w-full flex justify-center">
                      <div className="bg-black/20 size-20 rounded-full flex items-center justify-center">
                        <svg className="size-12 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                    ...
                    <div className="w-full flex flex-col gap-3">
                      <h4 className="text-2xl font-bold text-white">Autônomos</h4>

                      <ul className="w-full flex flex-col gap-2">
                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Agendamentos Automáticos</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Lembretes Integrados</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Dashboard Completo</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Link Personalizado para Clientes</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Configurações Flexíveis</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Acessível em Qualquer Hora</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Facilidade de Uso</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Experiencia do Cliente Elevada</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Mais Tempo Livre</span>
                        </li>

                        <li className="flex items-center gap-2">
                          <MoveRight color="#FFF" />

                          <span className="text-base text-white font-medium">Mais Organização</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="w-full flex flex-col items-center gap-4">
                    <span className="text-sm text-white font-medium text-center">
                      de <strong className="line-through font-medium">R$157,90</strong> por apenas R$127,90
                    </span>

                    <form className="w-full" action="/api/reactivate-checkout-session" method="POST">
                      <Button type="submit" role="link" size="xl" variant="secondary" className="w-full">
                        Contratar
                      </Button>
                    </form>
                    ...
                    <div className="w-full flex flex-col items-center gap-3">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm text-white font-medium">Compra segura</span>
                      </div>

                      <div className="flex items-center gap-1">
                        <BadgeCheck size={14} className="text-white" />

                        <span className="text-sm text-white font-medium">Satisfação garantida</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full p-4 bg-skin-primary rounded-2xl flex flex-col justify-between gap-4">
                  <div className="w-full flex flex-col gap-6">
                    <div className="w-full flex justify-center">
                      <div className="bg-black/20 size-20 rounded-full flex items-center justify-center">
                        <svg className="size-12 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                    ...
                    <div className="w-full flex flex-col gap-3">
                      <h4 className="text-2xl font-bold text-white">Empresas</h4>
